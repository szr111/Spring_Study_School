...
public class Test {
	...
	public static void main(String[] args) {
		...
		Container c = context.getBean("c1", Container.class);
		PersonBmiTool pbt = context.getBean("p2", PersonBmiTool.class);
		Random r1 = context.getBean("r1", Random.class);
		...
		for(   int i=0;i<1000;i++){
			...
			Person p7=new Person( "王八"+i,   1+Math.random()    ,   r1.nextInt(80)+30  );
			c.save(p7);
		}
